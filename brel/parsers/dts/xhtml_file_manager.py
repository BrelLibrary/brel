...
class XHTMLFileManager(IFileManager):
    ...
    def __init__(
        ...
        """
        :param cache_location: [str] The location where the schemas should be cached. This is the place where the computer
                                     dumps the XBRL files it downloads. The code that instantiates the XBRL file manager should
                                     have set this parameter.
        :param filenames: [list[str]] A list of filenames that you consider to form your XBRL filing.
        :param parser: [lxml.etree.XMLParser] The parser (from library LXML) that should be used to parse the XML files.
        """
