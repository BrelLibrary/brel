...
It parses XBRL in the XHTML syntax.
...
def parse_context_xhtml(
    xhtml_element: lxml.etree._Element,
    ...
    context_id = xhtml_element.get("id")
    ...
    context_period = xhtml_element.find("{*}period", namespaces=None)
    context_entity = xhtml_element.find("{*}entity", namespaces=None)
