    ...
    if segment is not None:
        for xml_dimension in segment:
            ...
            if "explicitMember" in xml_dimension.tag: 
                explicit_dimension_characteristic = parse_explicit_dimension_from_xml(xml_dimension, get_report_element, make_qname, get_from_cache, add_to_cache)
            ...
            # if it is a typed dimension, the tag is xbrli:typedMember
                ...
                typed_dimension_characteristic = parse_typed_dimension_from_xml(xml_dimension, get_report_element, make_qname, get_from_cache, add_to_cache)
