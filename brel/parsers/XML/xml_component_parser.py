...
def parse_component_from_xml(
    ...
    return Component(uri, info, presentation_network, calculation_network, definition_network)
...
def parse_components_xml(
    ...
    for schema in schemas:
        ...
        for roletype in roletypes:
            ...
            component = parse_component_from_xml(roletype, qname_nsmap, presentation_network, calculation_network, definition_network)
