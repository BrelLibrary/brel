...
You can edit how the documentation is generated by editing the `pydoc-markdown.yml` file in the project root. You can rebuild the documentation by running `make docs` and you can deploy the documentation by running `make serve-docs`.
