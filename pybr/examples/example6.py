...
from pybr.networks import ReferenceNetwork, CalculationNetwork
...
class SchemaResolver(lxml.etree.Resolver):
    def __init__(self, parser) -> None:
        self.cache_location = "pybr/dts_cache/"
...
def example6():
    ...
    # schema_tree = lxml.etree.parse("pybr/dts_cache/ko-20230630.xsd")
    # schema_tree = lxml.etree.parse("pybr/dts_cache/us-types-2023.xsd")
    # schema_tree = lxml.etree.parse("pybr/dts_cache/2003_xbrl-instance-2003-12-31.xsd")
    ...
    schema_tree = lxml.etree.parse("pybr/dts_cache/2020-01-21_types.xsd")
    # schema = lxml.etree.XMLSchema(schema_tree)
