...
% Obviously, if we open an XBRL report in a viewer such as Arelle, we do not see any QNames for the concepts, abstracts, etc.
% Instead, we see human-readable labels.
