...
% Even though open hypercubes are part of the XBRL specification, 
% As we will see in section \ref{sec:implementation}, the Brel API does support open hypercubes,
