...
% How a list of facts can be seen as a hypercube is illustrated using an example.
...
Data structuring through hypercubes has become widely adopted in recent years.
