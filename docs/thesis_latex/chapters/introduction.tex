...
% It is designed to be easy to use and well documented.
...
\begin{itemize}
    \item \textbf{\customlabel{RQ1}{RQ1}} How can the OIM be translated into an easy-to-use python API?
    \item \textbf{\customlabel{RQ2}{RQ2}} How can the non-OIM sections of XBRL be converted into an easy-to-use python API that is consistent with the OIM?
