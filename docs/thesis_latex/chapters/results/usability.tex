...
% The implementation of the viewer is shown in listing \ref{lst:viewer}.
...
\begin{figure}[H]
    ...
    \lstinputlisting[
        language=Python, caption={The implementation of the CLI XBRL report viewer}, 
        label={lst:viewer}, basicstyle=\scriptsize\ttfamily,
